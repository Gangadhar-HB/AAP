...
if __name__ == "__main__":
    ...
    vm_name = sys.argv[1]
    default_userdata = f'/declarations/user_data_{vm_name}'
    default_configdrive = f'/configdrives/configdrive_{vm_name}.iso'    

    USERDATA_FILE = os.getenv('USERDATA_FILE', default_userdata)
    ...
    CONFIGDRIVE_FILE = os.getenv(
        'CONFIGDRIVE_FILE', default_configdrive)
